...
function playGame (playerInput){
  ...
  const p1 = (argComputerMove == 'kamień' && argPlayerMove == 'papier'),
        p2 = (argComputerMove == 'papier' && argPlayerMove == 'nożyce'),
        p3 = (argComputerMove == 'nożyce' && argPlayerMove == 'kamień');

  const r1 = (argComputerMove == 'kamień' && argPlayerMove == 'kamień'),
        r2 = (argComputerMove == 'papier' && argPlayerMove == 'papier'),
        r3 = (argComputerMove == 'nożyce' && argPlayerMove == 'nożyce');

  const n1 = (argComputerMove == 'kamień' && argPlayerMove == '0'),
        n2 = (argComputerMove == 'nożyce' && argPlayerMove == '0'),
        n3 = (argComputerMove == 'papier' && argPlayerMove == '0');
